...
public class ProfileTest extends BasicTest{
	...
	//Assert.assertTrue(nsp. MessageText().contains("Login Successfull"));
	...
	//Thread.sleep(2000);
	//Assert.assertTrue(nsp. MessageText().contains("Setup Successful"));
	//Thread.sleep(2000);
	//ap.Logout();
	//Assert.assertTrue(nsp. MessageText().contains("Logout Successfull!"));
	//}
	...
	pp.uploadPicture();
	Thread.sleep(2000);
	Assert.assertTrue(nsp. MessageText().contains("Profile Image Uploaded Successfully"));
	nsp.NoMessage();
	Thread.sleep(2000);
	pp.deletePicture();
	Thread.sleep(2000);
	Assert.assertTrue(nsp. MessageText().contains("Profile Image Deleted Successfully"));
	nsp.NoMessage();
	Thread.sleep(2000);
	ap.Logout();
	Assert.assertTrue(nsp. MessageText().contains("Logout Successfull!"));
